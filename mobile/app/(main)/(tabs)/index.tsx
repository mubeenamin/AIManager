...
export default function DashboardScreen() {
  ...
  // Compute cost vs revenue for profit
      ...
      <ScrollView style={styles.scroll} showsVerticalScrollIndicator={false}>
        ...
        {lowStockProducts.length > 0 && (
          <TouchableOpacity
            ...
            onPress={() => router.push('/(main)/(tabs)/inventory')}
          >
        ...
        <View style={styles.actionGrid}>
          <TouchableOpacity
            ...
            onPress={() => router.push('/(main)/(tabs)/pos')}
          >
          ...
          <TouchableOpacity
            ...
            onPress={() => router.push('/(main)/(tabs)/finance')}
          >
          ...
          <TouchableOpacity
            ...
            onPress={() => router.push('/(main)/(tabs)/ai')}
          >
